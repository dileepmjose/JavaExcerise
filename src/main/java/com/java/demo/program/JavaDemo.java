...
import com.java.demo.dao.ProjectDao;
...
public  class JavaDemo {
    public static void main(String arg[]) {
        ...
        Stream<Employee> thridHihest = p.getEmployee().stream().sorted(Comparator.comparingDouble(Employee::getSalary).reversed()).skip(2).limit(1);
